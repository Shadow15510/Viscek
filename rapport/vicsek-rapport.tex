...
\section{Utilisation du code}
	...
	\begin{figure}[!h]
		\centering
		\begin{tabular}{cc}
			\includegraphics[width=7cm]{images/image_2.png} & \includegraphics[width=8cm]{images/image_1.png} \\
		\end{tabular}
...
\subsection{Ajout d'obstacles}
   ...
   Nous avons alors crée des murs, quifont office d'agents répulsifs immobiles. A leur vue, les agents font marche arrière pour éviter l'obstacle.
   ...
   Cependant, il faut admettre que l'ajout d'obstacle est assez difficile à coder.
